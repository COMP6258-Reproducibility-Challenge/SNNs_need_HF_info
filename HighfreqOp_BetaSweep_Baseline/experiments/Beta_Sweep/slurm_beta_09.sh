#!/bin/bash
#SBATCH --job-name=Beta_Sweep_b09
#SBATCH --nodes=1
...
#SBATCH --output=logs/Beta_Sweep_b09_%j.out
#SBATCH --error=logs/Beta_Sweep_b09_%j.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=kb6g21@soton.ac.uk

# =============================================================================
# Experiment 3.2 — β sweep: β=0.90 (τ=10.0)
# Longest time constant — strongest low-pass LIF behaviour.
# Run from experiments/Beta_Sweep/:
#   mkdir -p logs && sbatch slurm_beta_09.sh
# =============================================================================
...
TAU="10.0"
BETA="0.90"
MODEL="pool_former_beta_09"

echo "========================================================"
echo "  Exp 3.2 — β sweep  β=${BETA} (τ=${TAU})  [strongest low-pass]"
