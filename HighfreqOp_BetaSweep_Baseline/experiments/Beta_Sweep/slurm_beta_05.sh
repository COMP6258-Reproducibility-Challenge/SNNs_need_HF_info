#!/bin/bash
#SBATCH --job-name=Beta_Sweep_b05
#SBATCH --nodes=1
...
#SBATCH --output=logs/Beta_Sweep_b05_%j.out
#SBATCH --error=logs/Beta_Sweep_b05_%j.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=kb6g21@soton.ac.uk

# =============================================================================
# Experiment 3.2 — β sweep: β=0.50 (τ=2.00) — paper default
# Run from experiments/Beta_Sweep/:
#   mkdir -p logs && sbatch slurm_beta_05.sh
# =============================================================================
...
TAU="2.00"
BETA="0.50"
MODEL="pool_former_beta_05"

echo "========================================================"
echo "  Exp 3.2 — β sweep  β=${BETA} (τ=${TAU})  [paper default]"
