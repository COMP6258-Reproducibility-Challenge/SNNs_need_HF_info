#!/bin/bash
#SBATCH --job-name=Beta_Sweep_b075
#SBATCH --nodes=1
...
#SBATCH --output=logs/Beta_Sweep_b075_%j.out
#SBATCH --error=logs/Beta_Sweep_b075_%j.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=kb6g21@soton.ac.uk

# =============================================================================
# Experiment 3.2 — β sweep: β=0.75 (τ=4.00)
# Run from experiments/Beta_Sweep/:
#   mkdir -p logs && sbatch slurm_beta_075.sh
# =============================================================================
